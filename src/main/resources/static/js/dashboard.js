                                        ...
                                        <div class="ant-collapse-content ant-collapse-content-inactive ant-collapse-content-hidden">
                                            ...
                                            <div class="ant-collapse-item" id="productDescription">
                                                ...
                                                <div
                                                    ...
                                                    style="">
                                                    <div class="ant-collapse-content-box">
                                                        <div data-show="true" class="ant-alert ant-alert-warning" role="alert">
                                                            <span
                                                                role="img"
                                                            ...
                                                            <div class="ant-alert-content">
                                                                <div class="ant-alert-message">Vui lòng nhập tên sản phẩm và chọn đúng danh mục để xem các thông tin</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <div class="ant-table-body" style="overflow: auto scroll; max-height: 300px;">
                                                                            <table class="sc-jTYCaT gaaPWS">
                                                                                ...
                                                                                <tbody class="ant-table-tbody">
                                                                                    <tr class="sc-eGAhfa klMPTT ant-table-measure-row">
                                                                                        <td class="sc-hAsxaJ kzbhZy">
                                                                                            <div class="sc-kYWVYA hAUmuw">&nbsp;</div>
                                                                                        </td>
                                                                                        <td class="sc-hAsxaJ kzbhZy">
                                                                                            <div class="sc-kYWVYA hAUmuw">&nbsp;</div>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr class="ant-table-row ant-table-row-level-0">
                                                                                        <td
                                                                                            class="sc-bWXABl cpOOkN ant-table-cell ant-table-cell-fix-left ant-table-cell-fix-left-last">
                                                                                            <span class="ant-table-cell-content">1 xám 1 xanh dương</span>
                                                                                        </td>
                                                                                        <td id="offer[0].quantity" code="quantity" class="ant-table-cell ">
                                                                                            <div class="sc-gITdmR hDPrbi  ant-input  full-width ">
                                                                                                <span>&nbsp;</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td id="offer[0].selling_price" code="selling_price" class="ant-table-cell ">
                                                                                            <div class="sc-gITdmR hDPrbi  ant-input  full-width ">
                                                                                                <span>&nbsp;</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td id="offer[0].product_code" code="product_code" class="ant-table-cell ">
                                                                                            <div class="sc-gITdmR hDPrbi  ant-input  full-width ">
                                                                                                <span>&nbsp;</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td
                                                                                            class="sc-eFWqGp cgMTsh ant-table-cell ant-table-cell-fix-right ant-table-cell-fix-right-first">
                                                                                            <span class="ant-table-cell-content">
                                                                                                <button
                                                                                                    type="button"
                                                                                                    class="ant-btn ant-btn-danger ant-btn-icon-only ant-btn-background-ghost sc-bhVIhj drGzfM">
                                                                                    ...
                                                                                    <tr class="ant-table-row ant-table-row-level-0">
                                                                                        <td
                                                                                            class="sc-bWXABl cpOOkN ant-table-cell ant-table-cell-fix-left ant-table-cell-fix-left-last">
                                                                                            <span class="ant-table-cell-content">1 xanh đen 1 xanh dương</span>
                                                                                        </td>
                                                                                        <td id="offer[1].quantity" code="quantity" class="ant-table-cell ">
                                                                                            <div class="sc-gITdmR hDPrbi  ant-input  full-width ">
                                                                                                <span>&nbsp;</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td id="offer[1].selling_price" code="selling_price" class="ant-table-cell ">
                                                                                            <div class="sc-gITdmR hDPrbi  ant-input  full-width ">
                                                                                                <span>&nbsp;</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td id="offer[1].product_code" code="product_code" class="ant-table-cell ">
                                                                                            <div class="sc-gITdmR hDPrbi  ant-input  full-width ">
                                                                                                <span>&nbsp;</span>
                                                                                            </div>
                                                                                        </td>
  ...
  for(let i = 0; i < operations.length; i++) {
      ...
      input.addEventListener("keypress",function(event) {
          if(event.key === "Enter") {
              ...
              inputVariation(event);
          }
      });
  }
}

function inputVariation(event) {
...
function inputValue(event, variation) {
    let find = bucket.find(item=>item.variation === variation);
    if(!find) {
        bucket.push({
            values : event.target.value.split(",")
        })
    }else{
        find.values = event.target.value.split(",");
    }
    for(let i = 0; i < bucket.length; i++) {
        for(let j = 0 ; j < bucket[i].values.length; j++) {
            let options = variation + "-" + bucket[i].values[j].trim();
            let search = variationBucket.find((item) => item.options === options);
            if(!search) {
                variationBucket.push({options});
            }
        }
    }
    console.log(variationBucket);
}
